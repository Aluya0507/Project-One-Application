...
public class TestHashTable {
	...
	/*
	 * Tests the MapData class that inputs all the countries and their respective
	 * data into a map. Makes sure the countries and info are retrievable when
	 * called with the correct line number from the countries.csv file.
	 */
